...
The tkmeans package attempts to implement the trimmed k-means algorithm of Garcia-Escudero, et. al.(2008) using as little memory as possible. Data is edited in place, the trimming is implemented using a priority queue structure in C++ through Rcpp and low memory use versions of utility functions are provided.
